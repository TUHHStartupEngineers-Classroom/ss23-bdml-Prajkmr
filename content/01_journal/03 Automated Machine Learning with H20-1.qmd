...
<mark>\n(d)It's difficult to deduce anything based on the visualization</mark>
...
<mark>\n(b)Those that are staying have a higher stock option level</mark>
...
<mark>\n(b)A higher proportion of those leaving have a high environment satisfaction level</mark>
\n(c)It's difficult to deduce anything based on the visualization
